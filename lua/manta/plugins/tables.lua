	...
	config = function()
		require("easytables").setup({
			...
			set_mappings = function(buf)
				...
				vim.api.nvim_buf_set_keymap(buf, "n", "<A-Left>", ":SwapWithLeftColumn<CR>", {})
				vim.api.nvim_buf_set_keymap(buf, "n", "<A-Right>", ":SwapWithRightColumn<CR>", {})
				vim.api.nvim_buf_set_keymap(buf, "n", "<A-Up>", ":SwapWithUpperRow<CR>", {})
				vim.api.nvim_buf_set_keymap(buf, "n", "<A-Down>", ":SwapWithLowerRow<CR>", {})

				vim.api.nvim_buf_set_keymap(buf, "n", "<leader>dc", ":DeleteColumn<CR>", {})
				vim.api.nvim_buf_set_keymap(buf, "n", "<leader>dr", ":DeleteRow<CR>", {})
				vim.api.nvim_buf_set_keymap(buf, "n", "<leader>st", ":ExportTable<CR>", {})
			end,
		})
	end,
}
